...
/**  
 * 类说明:自助终端发布版本service接口
 * @author 朱伟权
 * 创建时间: 2017-7-6 上午11:06:23
 */
public interface SelfServiceVersionService {
	 ...
	 * @throws Exception 
	 */
	boolean save(SelfServiceVersionPO po) throws Exception;
	
	/**
	 * 统计升级情况
	 * @param po 统计对应的版本
	 * @return 返回信息包括相应终端类型的总台数、已升级台数、未升级台数
	 */
