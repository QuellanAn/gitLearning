...
@Repository("hosinfoDao")
public class HosinfoDaoImpl extends BaseDao implements IHosinfoDao {

	@Override
	public void add(Hosinfo info) {
		String sql="insert into enterprize_hos_info(title,content,author,image,type,createtime)" +
				" values(?,?,?,?,?,NOW())";
