...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	private static String key = "InternetszcaticFysrmyyWechat2016";

	//微信分配的公众号ID（开通公众号之后可以获取到）
	private static String appID = "wx4c943e86b74a6a8f";

	//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private static String mchID = "1357222402";
	...
	private static String certPassword = "1357222402";

	//是否使用异步线程的方式来上报API测速，默认为异步模式
	private static boolean useThreadToDoReport = true;

	//机器IP
//	private static String ip = "112.27.43.71";
	private static String ip = "202.104.122.115";
	//微信签名方式
