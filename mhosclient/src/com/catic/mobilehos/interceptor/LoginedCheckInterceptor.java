...
//    }
	...
	if (url.indexOf("manager_")!=-1 || url.indexOf("logout")!=-1/*
			|| url.indexOf("selfServiceLogAction_uploadLog") != -1
			|| url.indexOf("selfServiceUpgradeAction_getLatestVersion") != -1
			|| url.indexOf("selfServiceUpgradeAction_reportUpgradeInfo") != -1*/){
         return ai.invoke();
	}else if (name != null) {
		ai.invoke();
	}else{
