...
<script charset="utf-8" src="trade/pay_main.js"></script>
<script type="text/javascript">
</script>
</head>
<!-- <s:if
					...
					<div class="left-list-hd" style="height: 40px; margin:0px;">
							<table height="100%" style="margin-top: -2px;">
								<tr>
									...
									<td valign="middle">
									<input type="text" id="cardNo" style="height: 28px; line-height: 28px;width: 110px;">
									</td>
									<td valign="middle" align="right">就诊人:</td>
									<td valign="middle">
									<input type="text" id="patientname" style="height: 28px; line-height: 28px;width: 110px;">
									</td>
									<td valign="middle" align="right">充值途径:</td>
										<td valign="middle" align="left"><select id="paySence"
										    style="width: 110px;height: 28px;">										
										</select></td>
									...
									<%-- <td valign="middle" align="right">充值状态:</td>
