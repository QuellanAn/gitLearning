...
<script charset="utf-8" src="payChannel/payChannel.js"></script>
</head>
<!-- <s:if
			...
			<div class="tab-cnt">
				<div class="f-fl left-list-wrap">
					<div class="left-list-hd">
						<span class="f-fl">支付通道配置(<span id="totalcount"></span>)
						</span>
					</div>
					<div class="left-list-hd" style="height: 80px;">
							<table height="100%" style="margin-top: -3px;">
								<tr>
									...
									<td valign="middle"><select id="district" name="yqCode"
									...
									<td valign="middle" align="right">支付场景:</td>
										<td valign="middle" align="left"><select id="payScene"
										    name="sCode" style="width: 130px;height: 28px;">										
									</select></td>
							     	<td width="15px"></td>
									<td valign="middle" align="right">资金账户:</td>
										<td valign="middle" align="left"><select id="account"
										    name="accountCode" style="width: 130px;height: 28px;">										
									</select></td>
									<td width="15px"></td>
									<td valign="middle" align="right">支付方式:</td>
										<td valign="middle" align="left"><select id="payType"
										    name="ptCode" style="width: 130px;height: 28px;">										
									</select></td>
								</tr>
								<tr>								
									<td valign="middle" align="right">状态:</td>
										<td valign="middle" align="left"><select id="cStatus"
										    name="" style="width: 130px;height: 28px;">	
									...
									<td valign="middle" width="70" align="right" colspan="7">
									<input class="save-btn" type="button" value="添加" 
										onClick="javascript:toAdd();"></td>
								</tr>
							</table>
					</div>
