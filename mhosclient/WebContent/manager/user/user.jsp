					...
					<div class="left-list-hd">
						<s:form id="searchUserForm" action="searchUser" theme="simple">
							<table height="100%" style="margin-top: 0px;">
								<tr>
									<td valign="middle" style="color: #0079ff;font-size : 14px;">用户账号 :</td>
									<td valign="middle"><s:textfield id="user_name" name="user_name" size="10" cssStyle="height: 28px; line-height: 28px;" /></td>
									<td valign="middle" style="color: #0079ff;font-size : 14px;">账号状态：</td>
									...
									<td valign="middle" style="color: #0079ff;font-size : 14px;">注册时间:</td>
									...
									<td valign="middle" style="padding-left: 20px;"><input id="" type="submit" class="save-btn" value="查询" /></td>
