...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/manager/sysUser/role_update.js"></script>
<style>
.ztree li {
	min-height: 5px;
}
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			...
			<div class="tab-cnt" style="overflow: auto;">
				<s:form id="updateRoleForm" action="updateRoleAction" method="post"
					...
					<br />
					<center>
						<input id="updateButton" type="button" value="提交"
							class="normal-btn">
					</center>
					<s:hidden id="au_ids" name="au_ids" />
				</s:form>
