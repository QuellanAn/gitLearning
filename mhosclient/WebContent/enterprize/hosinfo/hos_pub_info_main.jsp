...
<script charset="utf-8" src="enterprize/hosinfo/hos_pub_info_main.js"></script>
</head>
<body>
					...
					<div class="left-list-hd">
						<form id="form_query">
							<table height="100%" style="margin-top: -3px;">
								<tr>
									<td valign="middle" align="center" width="80">咨询分类:</td>
									<td valign="middle" align="left"><select id="type" name="info.type"
										style="width: 100px; height: 28px; padding: 4px 8px;">
											<option value="">全部</option>
											<option value="0">院内咨询</option>
											<option value="1">业内新闻</option>
									</select></td>
									...
									<td valign="middle"><input type="text" id="author"
										name="info.author" style="width: 80px; height: 18px; padding: 4px 8px;"/>
									<td>
