$(document).ready(function() {
	loadinfocats(0);
	datalist_ctrl.loaddatalist("hosinfomng/getApprovedHosPubInfoList?page=1");
	...
	$("#act_query").click(function(e){
		...
		var url = "hosinfomng/getApprovedHosPubInfoList?page=1&" + paras;
...
function deletehospub(e,c, p){
	if (confirm("你确认要删除该条记录吗？")){
		$.post("hosinfomng/deletehospub",
				{infoid:e,infocatcode: c, page:p},
				function success(data,status){
				});
		window.location.href = "hosinfomng/hos_pub_info_main_pub.jsp";
	}
}
