				...
				enctype="multipart/form-data" cssClass="introduction-fm">
					...
					<ul>
						<li><span class="introduction-label f-fl"> <span
								...
								cssClass="fm-text f-fl" style="width:550px;" maxLength="11"/>
						...
						<li>
							<span class="introduction-label f-fl"> <span
							 ...
							 <img class="introduction-pmt" src="<%=request.getAttribute("iconValue") %>" onerror="this.onerror=null;this.src='resources/images/iocn_yyzy_jyzn.png'" id="img" height="120" width="180"/>
						</li>
