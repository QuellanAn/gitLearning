	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li class="tab-crt"><a href="busrecord/pay/pay_main.jsp">缴费记录</a></li>
			</ul>
			<div class="tab-cnt">
							...
							<table height="100%" style="margin-top: -3px;">
								<tr>
								 <td valign="middle" align="right">缴费单号：</td>
									<td valign="middle">
									<input type="text" name="docbillsn" size="10"  id="docbillsn" style="height: 28px; line-height: 28px; widows: ">
									</td>
									...
									<!-- <td valign="middle" align="right">缴费流水号：</td>
									<td valign="middle">
									<input type="text" name="curdocsn" size="10"  id="curdocsn" style="height: 28px; line-height: 28px; widows: ">
									</td>
									</tr>
									<tr>
									...
									<td valign="middle" ><select id="status"
