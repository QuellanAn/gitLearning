...
<script type="text/javascript" src="role/saveRole.js"></script>
		...
		<div class="right-cnt-wrap f-fl">
			...
			<div class="f-fl left-list-wrap">
				<div id="div_cnt_table">
					<s:form id="myform" action="role_save" method="post">
					<s:hidden name="role.ids" id="ids"></s:hidden>
					<table id="tab-cnt" class="list-table">
						<tbody id="tb_cnt_body"  >
							...
							<%-- <tr>
								...
								<td align="left"><s:radio id="category" name="role.category" list="#{'1':'超级管理员','3':'服务商管理员','4':'银行管理员'}"  value="3"/></td>
							</tr> --%>
							<tr>
