			...
			<s:form method="post" action="accountConfigAction_modifyAccount"  id="form_modify" cssClass="introduction-fm">
					<ul>
                        ...
                        <li><span class="introduction-label f-fl"
							style="width: 130px;text-align:left"><span class="color-red">*</span>状态：</span>
							<s:select id="status" name="account.status"
								list="#{0:'启用',1:'禁用'}" listKey="key" listValue="value"
								cssClass="fm-text f-fl" style="width:240px;margin-left: -10px;" />	
							<div class="f-clear"></div>
						</li>
						<li><span class="introduction-label f-fl" style="width:120px;text-align:left;">备注: </span> 
						 <s:textfield
								id="" name="account.remark"
								 Class="fm-text f-fl" style="width:550px;"/>
							<div class="f-clear"></div></li>
					</ul>
					...
					<center>	
					    ...
					    <s:hidden name="account.aid"></s:hidden>				  
						<input id="submit" type="submit"  value="提交" style="margin-bottom: 10px;"
