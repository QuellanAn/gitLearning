							...
							<table height="100%" style="margin-top: -3px;">
								<tr>
								  <td valign="middle" align="right">交易单号:</td>
									<td valign="middle">
									<input type="text"  size="10"  id="out_trade_no" style="height: 28px;width:190px; line-height: 28px; widows: ">
									</td>
									 <td valign="middle" align="right">&nbsp;&nbsp;第三方交易流水号:</td>
									<td valign="middle">
									<input type="text" id="orderCode"  size="10"  style="height: 28px;width:190px; line-height: 28px;">
									</td>
									 <td valign="middle" align="right">&nbsp;&nbsp;HIS交易流水号:</td>
								     <td valign="middle" align="right">
								     <input type="text" id="hisTransId"  size="10"  style="height: 28px;width:190px; line-height: 28px;">
								     </td>
