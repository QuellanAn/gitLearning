...
//	var userSource = $("#userSource").val();
	...
	$.ajax({
		...
		data:{"beginDate":beginDate, "endDate":endDate, "type":type, "regSource":userSource, "countType":countType,"ajaxType":"json"},
		dataType : "json",
		async : true,
