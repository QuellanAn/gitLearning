...
<script charset="utf-8" src="statistics/patientRecord/patientRecord_main.js"></script>
<style type="text/css">
ul.nav-tabs{
	width: 130px;
	height: 35px;
							...
							<form id="form_query">
								<table height="100%" style="margin-top: 3px;">
									<tr>
										...
										<td valign="middle" align="right">建档来源:</td>
