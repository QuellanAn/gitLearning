...
<script charset="utf-8" src="statistics/paymentStatistics/payment_proportion_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li><a href="statistics/paymentStatistics/paymentStatistics_main.jsp">缴费趋势统计</a></li>
				<li class="tab-crt">缴费占比统计</li>
			</ul>
			<div class="tab-cnt">
