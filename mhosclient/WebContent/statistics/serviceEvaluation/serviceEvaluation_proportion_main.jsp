...
<script charset="utf-8" src="statistics/serviceEvaluation/serviceEvaluation_proportion_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
