		...
		<div class="right-cnt-wrap f-fl">
			...
			<div class="f-fl left-list-wrap">
				<div id="div_cnt_table">
					<s:form id="modifyform" action="manager_modify" method="post">
					<s:hidden name="manager.userId" id="id" />
					<table id="tab-cnt" class="list-table">
						<tbody id="tb_cnt_body"  >
							<tr>
								<td align="center"><font color="red">*</font>账号</td>
								<td align="center"><s:textfield id="muserName" name="manager.userName" cssClass="fm-text f-fl" style="width:235px;" /></td>
								<td align="center"><font color="red">*</font>密码</td>
								<td align="center">
									<s:password id="pwd"  cssClass="fm-text f-fl" style="width:235px;"  placeholder="如需修改密码，请输入新密码"/>
							...
							<tr>
								...
								<td align="center"><s:textfield id="mtel" name="manager.tel" cssClass="fm-text f-fl" style="width:235px;" /></td>
								<td align="center"><font color="red">*</font>分配角色</td>
								<td align="left">
									<s:select onchange="jueshe(this)" id="mroleId" name="manager.roleId" headerKey="0" headerValue="请选择" list="%{roleList}" listKey="%{roleId}" listValue="%{name}"  cssClass="fm-text f-fl" style="width:250px;" />
								</td>
							</tr>
							<%-- <tr>
								<td align="center">角色类型</td>
								<td align="left"><s:radio id="category" name="category" list="#{'1':'超级管理员','3':'服务商管理员','4':'银行管理员'}" cssStyle="width:30px;" value="manager.category"/>
								<td align="center">所属部门</td>
								<td align="center">
									<s:textfield id="department" name="manager.department" cssClass="fm-text f-fl" style="width:235px;" />
								</td>
							</tr> --%>
							<tr>
