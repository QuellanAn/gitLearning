...
<div id="div_cn">
	<s:form id="myform" action="usermanage/specialist_modify" method="post" enctype="multipart/form-data">
	<table id="tab-cnt" class="dialog-table">
		<tbody id="tb_cnt_body">
			<tr>
				<input type="hidden" name="specialist.id" value="${specialist.id}"/>
				<td align="center">医生编号<font style="color: red;">*</font></td>
				<td>${specialist.code}</td>
				<td align="center">医生姓名<font style="color: red;">*</font></td>
				<td align="center"><input type="text" name="specialist.name" id="dname" value="${specialist.name}" style="padding: 5px 5px;" /></td>
			</tr>
			<tr>
				...
				<td align="center">
					<select name="specialist.department" id="department" style="width:180px; padding: 5px 5px;">
						<option value="${specialist.department}">${specialist.department}</option>
			...
			<tr>
				...
				<td align="center">
					<img src="data:image/*;base64,${specialist.image}" style="width: 100px; height: 150px;" />
				</td>
				<td align="center" colspan="2">
					<input type="file" name="file" id="photo" style="padding: 5px 5px;"/>
					<br/><span style="color:#C7C7C7;">请选择.gif,jpeg,jpg,png格式照片上传(2M)</span>
				</td>
			</tr>
			<tr>
				<td align="center">医生简介<font style="color: red;">*</font></td>
				<td align="center" colspan="3"><textarea rows="12" cols="90" name="specialist.depict" id="depict">${specialist.depict}</textarea> </td>
			</tr>
			<tr>
				<td align="center">擅长领域<font style="color: red;">*</font></td>
				<td align="center" colspan="3"><textarea rows="6" cols="90" name="specialist.adept" id="depict">${specialist.adept}</textarea> </td>
			</tr>
			<tr>
				<td align="center" colspan="4">
					<button id="btn_modify" class="save-btn" onclick="modify();return false;">提交</button>
				</td>
			</tr>
		</tbody>
	</table>
