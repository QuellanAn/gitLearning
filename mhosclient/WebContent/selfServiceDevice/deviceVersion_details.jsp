					...
					<table class="list-table" style="table-layout:fixed;">
						...
						<tr>
							...
							<td width="20%" style="color: blue;border-right: none;">
								<button class="save-btn" style="width: 130px;" onclick="location.href='selfService/selfServiceUpgradeAction_toVersionHistory?terminalId=${payTer.facilityId}&upgradeType=0'">查看历史升级记录</button>
							</td>
							<td width="10%" style="color: blue;border-right: none;"></td>
							<td width="20%" style="color: blue;"></td>
						...
						<tr>
							...
							<td width="20%" style="color: blue;border-right: none;">
								<button class="save-btn" style="width: 130px;" onclick="location.href='selfService/selfServiceUpgradeAction_toVersionHistory?terminalId=${payTer.facilityId}&upgradeType=1'">查看历史升级记录</button>
							</td>
							<td width="10%" style="color: blue;border-right: none;"></td>
							<td width="20%" style="color: blue;"></td>
