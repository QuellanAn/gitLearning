	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			...
			<s:form method="post" action="selfServiceManageAction_saveOrUpdate"  id="formTerminal" cssClass="introduction-fm">
					...
					<input type="hidden" id="oldFacilityId" value="${payTer.facilityId }"/>
					<ul>
						...
						<li><span class="introduction-label f-fl intro_label"><span
							...
							<s:select id="facilityType"
								name="payTer.facilityType" list="#request.facilityTypeList"
								listKey="codeNo" listValue="codeName" cssClass="fm-text f-fl" style="width:240px;" />
						</li>
		...
		$.ajax({
			...
			success : function(data) {
				if(data.result){
					...
					var oldFacilityId = $("#oldFacilityId").val();
					if(oldFacilityId == facilityId){// 如果还是原来的终端编号，检查通过
						checkResult = true;
					}else{// 修改为其他的终端编号，但是已存在，不允许
