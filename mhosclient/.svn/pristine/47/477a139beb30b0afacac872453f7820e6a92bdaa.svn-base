...
<script charset="utf-8" src="statistics/serviceEvaluation/serviceEvaluation_amount_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li><a href="statistics/serviceEvaluation/serviceEvaluation_main.jsp">服务评价趋势统计</a></li>
				<li><a href="statistics/serviceEvaluation/serviceEvaluation_proportion_main.jsp">服务评价占比统计</a></li>
				<li class="tab-crt">服务评价量统计</li>
			</ul>
			<div class="tab-cnt">
				<div class="f-fl left-list-wrap">
						...
						<div style="float: left;">
							<form id="form_query">
								<table height="100%" style="margin-top: 3px;">
									...
									<tr>
										<td>评价日期:</td>
										<td valign="middle" style="padding-left: 10px;" align="left" colspan="3">
					...
					<div class="divSum">
						<span class="text">科室综合好评统计结果</span>
					</div>
					<%-- <div class="divDepartmentCount">
						<a href="javascript:void(0)" onclick="toDepartmentChange()">查看科室变化趋势</a>
					</div> --%>
					<div style="overflow-x: scroll;margin:20px auto;clear:both; min-height: 450px;width: 98%;"
						id="Section1">
						<table class="list-table" style="width: 100%; height: 100%;text-align: center;">
