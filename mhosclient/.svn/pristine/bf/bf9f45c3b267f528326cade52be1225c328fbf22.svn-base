...
<script charset="utf-8" src="statistics/rechargeStatistics/rechargeStatistics_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li class="tab-crt">充值趋势统计</li>
				<li><a href="statistics/rechargeStatistics/recharge_proportion_main.jsp">充值占比统计</a></li>
			</ul>
			<div class="tab-cnt">
