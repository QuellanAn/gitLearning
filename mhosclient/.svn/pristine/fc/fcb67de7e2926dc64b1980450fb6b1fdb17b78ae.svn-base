...
import com.catic.mobilehos.pay.biz.IServiceRequBiz;
 ...
 * Time: 14:36
 */
public class HttpsRequest implements IServiceRequBiz{
    ...
    private Log log = new Log(Logger.getLogger(this.getClass()));
