...
<script charset="utf-8" src="config/wechat/basecontent_cfg.js"></script>
</head>
<!-- <s:if
			...
			<div class="tab-cnt">
				<div class="f-fl left-list-wrap">
					<div class="left-list-hd">
						<span class="f-fl">须知分类列表(<span id="totalcount"></span>)
						</span>
					</div>
					<div class="left-list-hd">
						<form id="form_query">
							<table height="100%" style="margin-top: -3px;">
								<td valign="middle">标题:</td>
									<td valign="middle"><input type="text" id="cat_name"
										name="cat_name" style="width: 80px; height: 18px; padding: 4px 8px;"/>
									<td>
									<td valign="middle" width="10" align="right">
									<td valign="middle">操作人:</td>
									<td valign="middle"><input type="text" id="update_people"
										name="update_people" style="width: 80px; height: 18px; padding: 4px 8px;"/>
									<td valign="middle" width="10" align="right">
									...
									<INPUT class="save-btn" type="button" value="添加" 
										onClick="location.href='config/wechat/add_edit_basecontent.jsp'"></td>
								</tr>
							</table>
						</form>
					</div>
