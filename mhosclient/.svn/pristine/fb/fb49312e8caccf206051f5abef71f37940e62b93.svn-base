...
<script  charset="utf-8" src="yqconfig/yqconfig.js"></script>
</head>
<!-- <s:if
			...
			<div class="tab-cnt">
				<div class="f-fl left-list-wrap">
					<div class="left-list-hd">						
						 <span class="f-fl">院区配置(<span id="totalcount"></span>)
						</span><!--  <a href="javascript:toAddYQ()"  class="new-link f-fr">添加</a> -->
					</div>
