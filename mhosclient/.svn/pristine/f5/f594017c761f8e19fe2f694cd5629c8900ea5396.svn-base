	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li class="tab-crt"><a href="trade/trade_main.jsp">建档发卡记录</a></li>
			</ul>
			<div class="tab-cnt" id="tb_cnt">
				<div class="f-fl left-list-wrap">
					<div class="left-list-hd">
						<span class="f-fl">建档发卡记录列表(<span id="totalcount"></span>)
						</span>
					</div>
						...
						<form id="form_query">
							<table height="100%" style="margin-top: -2px;">
								<tr>
									...
									<td valign="middle" align="left">手机号：</td>
									<td valign="middle">
								...
								<tr>
									...
									<td valign="middle" align="center">建档途径：</td>
										<td valign="middle" align="left"><select id="patientSource" name="patientSource"
										    style="width: 93px;height: 28px;">
									</select></td>
									<td valign="middle" align="center">建档发卡时间：</td>
									...
									<td valign="middle" align="right" style="padding-left: 50px;"><button id="act_query"
