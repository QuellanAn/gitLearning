$(document).ready(function() {
	datalist_ctrl.loaddatalist("busrecord/getItems?page=1");//pay用于区分从哪里进getAppRegistList，0表示从缴费记录进入，1表示从挂号记录进入

	$("#act_query").click(function(e) {
		var paras = $("#form_query").serialize();
		var url = "busrecord/getItems?page=1&" + encodeURI(paras);
