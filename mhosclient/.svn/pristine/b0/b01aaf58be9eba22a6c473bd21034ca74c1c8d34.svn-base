...
<script type="text/javascript" src="config/basic/fun.js"></script>
</head>
<!-- <s:if
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				...
				<li class="tab-crt"><a href="config/basic/fun">操作指南</a></li>
				<li><a href="config/basic/faq">常见问题</a></li>
			</ul>
			<div class="tab-cnt">
				<div class="f-fl left-list-wrap">
					<div class="left-list-hd">
						<span class="f-fl"><strong>操作指南：</strong><span id="title_guide">Android版</span></span>
					</div>
					<div id="div_cnt_table">
						<s:hidden id="action" value="save" />
						<s:form id="addGuideForm" method="post" theme="simple">
							<s:hidden id="cfg_type" name="cfg_type" value="2" />
							<s:hidden id="cat" name="cat" value="1" />
							<s:hidden id="cat_name" name="cat_name" value="Android版" />
							<s:hidden id="htmlFileName" name="htmlFileName"
								value="getandroidfun.html" />
							<textarea id="content" name="content" rows="25" cols="80"></textarea>
							<br />
							<center>
