...
<script charset="utf-8" src="statistics/rechargeStatistics/recharge_proportion_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li><a href="statistics/rechargeStatistics/rechargeStatistics_main.jsp">充值趋势统计</a></li>
				<li class="tab-crt">充值占比统计</li>
			</ul>
			<div class="tab-cnt">
