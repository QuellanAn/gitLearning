...
var datalist_ctrl = {
	...
	loaddatalist:function(pageNo){
			...
			$.get('unpaid/accountConfigAction_findAll?pageNo='+pageNo,
...
//跳转到编辑界面
function toModify(accountCode){		
	window.location.href="unpaid/accountConfigAction_toModify?accountCode="+accountCode;
}