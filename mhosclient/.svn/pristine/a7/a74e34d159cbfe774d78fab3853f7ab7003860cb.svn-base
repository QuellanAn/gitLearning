...
<script charset="utf-8" src="statistics/serviceEvaluation/serviceEvaluation_main.js"></script>
<style type="text/css">
span.gap{
	margin-left: 10px;
	margin-right: 10px;
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				<li class="tab-crt">服务评价趋势统计</li>
				<li><a href="statistics/serviceEvaluation/serviceEvaluation_proportion_main.jsp">服务评价占比统计</a></li>
				<li><a href="statistics/serviceEvaluation/serviceEvaluation_amount_main.jsp">服务评价量统计</a></li>
			</ul>
			<div class="tab-cnt">
						...
						<div style="float: left;">
							<form id="form_query">
								<table height="100%" style="margin-top: -3px;">
									<tr>
										<td>评价来源:</td>
										<td valign="middle" style="padding-left: 10px;" align="left" colspan="2">
