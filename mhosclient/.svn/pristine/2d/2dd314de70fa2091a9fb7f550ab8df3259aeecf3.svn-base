		...
		<div class="right-cnt-wrap f-fl">
			<ul class="tab-wrap bg">
				...
				<s:if test="po.payStatus==3">
					<li ><a href="../unpaid/refundAction_findDetails?tradeNo=${po.out_trade_no}">退款记录详情</a></li>
				</s:if>
				<li ><a href="../unpaid/payLogAction_findLog?out_trade_no=${po.out_trade_no}&orderId='${po.orderId}'&payStatus=${po.payStatus}">交易日志</a></li>
			</ul>
					...
					<table width="100%" height="100%" style="margin-top: 0px;">
						...
						<table class="list-table" style="table-layout:fixed;">
							...
							<tr>
								...
								<td>
									${fn:substring(po.creatDate, 0, 19) }
								</td>
								<td align="center" style="background-color: #F2F2F2;">
								  支付时间
								</td>
								<td>
									${fn:substring(po.time_expire, 0, 19) }
								</td>
							</tr>
							<tr>
								<td align="center" style="background-color: #F2F2F2;">
								...
								<td style="border-right: none;">
									${fn:substring(po.updateTime, 0, 19) }
								</td>
								<td colspan="2">
