...
<body>
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl">
			...
			<div class="tab-cnt" style="margin-bottom: 10px;">
				<div style="margin-left : 50px;width: 1040px;border: 1px solid #ccc;">
					<div style="background-color: #f3f3f3;height: 42px;padding-left: 20px;">就诊信息</div>
				...
				<div style="margin-left : 50px;width: 1040px;border: 1px solid #ccc;margin-top: 20px;">
					<div style="background-color: #f3f3f3;height: 42px;padding-left: 20px;">评价信息</div>
					<div style="width: 100%;height: 312px;">
						<div class="patient-feft1" style="width: 100%;">
							<div class="patient-feft">
								...
								<div class="patient-feft">
									<%-- <s:if test="serviceEvaluationHosVO.overallEvaluation==0">好评</s:if>
									<s:if test="serviceEvaluationHosVO.overallEvaluation==1">中评</s:if>
									<s:if test="serviceEvaluationHosVO.overallEvaluation==2">差评</s:if> --%>
									${serviceEvaluationHosVO.overallEvaluationName} 
								</div>
							</div>
							<div style="padding-left: 50px;height: 42px;float: left;width: 100%;">
								<div style="height: 100%;float: left;width: 56px;">评价时间   </div>
								<div class="patient-feft">${fn:substring(serviceEvaluationHosVO.createDate, 0, 16) }</div>
							</div>
