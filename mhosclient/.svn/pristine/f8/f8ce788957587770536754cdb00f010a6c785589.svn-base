...
public class Refund {
	...
	private Integer hisPayStatus;
	private Integer hisStatus;
	private Integer outStatus;
	private String yqName;// 院区
	private String districtId;// 院区id
	private String account;//  资金账户编号
	private String accountName;// 资金账户名

	
	private String body;//缴费项目
	private String patientId;//病人ID
	private String total_fee;//应缴费用
	...
	public Double getTatolFee() {
		return tatolFee;
	}
	public void setTatolFee(Double tatolFee) {
	...
	public Integer getHisPayStatus() {
		return hisPayStatus;
	}
	public void setHisPayStatus(Integer hisPayStatus) {
