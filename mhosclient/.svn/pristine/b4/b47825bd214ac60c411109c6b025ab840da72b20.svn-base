		...
		<div class="right-cnt-wrap f-fl">
			...
			<div class="tab-cnt" style="padding-bottom: 10px;">
					...
					<div style="width: 100%;height: 126px;">
						<div class="patient-feft1">
							<div class="patient-feft">
								<div class="patient-feft2">就诊卡号   </div>
								<div class="patient-feft">
						...
						<div class="patient-feft1">
							...
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2">年龄 </div>
								<div class="patient-feft">
				...
				<div style="margin-left : 50px;width: 1040px;border: 1px solid #ccc;margin-top: 20px;">
					<div style="background-color: #f3f3f3;height: 42px;padding-left: 20px;">挂号基本信息</div>
					<div style="width: 100%;height: 168px;">
						<div class="patient-feft1">
							...
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2">挂号科室   </div>
								<div class="patient-feft">${appRegOrdersPO.departmentName } </div>
							</div>
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2">挂号途径   </div>
								<div class="patient-feft">
							...
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2">挂号时间  </div>
						...
						<div class="patient-feft1">
							<div class="patient-feft">
								<div class="patient-feft2">就诊人 </div>
								<div class="patient-feft">
									${patientPO.patientName } 
								</div>
							</div>
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2">挂号医生  </div>
								<div class="patient-feft">
									${appRegOrdersPO.doctorName }
								</div>
							</div>
							<div class="patient-feft" style="width: 100%;">
								<div class="patient-feft2"> 挂号状态  </div>
								<div class="patient-feft"><s:iterator var="appRegOrdersPO" value="aropo">${appRegOrdersPO.statusName } </s:iterator> </div>
							</div>
							<%-- <div class="patient-feft" style="width: 100%;">
				...
				<div style="margin-left : 50px;width: 1040px;border: 1px solid #ccc;margin-top: 20px;">
					<div style="background-color: #f3f3f3;height: 42px;padding-left: 20px;">缴费信息</div>
					<div style="width: 100%;height: 126px;">
						<div class="patient-feft1">
							<div class="patient-feft">
