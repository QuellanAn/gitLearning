						...
						<form id="form_query">
							<table height="100%" style="margin-top: -2px;">
								...
								<tr>
									...
									<td valign="middle" align="left">预约医生：</td>
									<td valign="middle">
									...
									<%-- <select id="status"
										name="status" style="height: 28px;width:98px;">
