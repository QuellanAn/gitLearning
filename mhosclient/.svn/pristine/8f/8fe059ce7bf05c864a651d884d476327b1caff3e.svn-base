...
<script charset="utf-8" src="hosinfomng/prev_sp_hosinfo.js"></script>
	...
	<div class="cnt-wrap">
		...
		<div class="right-cnt-wrap f-fl" style="min-height: 500px;">
			...
			<div class="tab-cnt">
				...
				<center>
					<button id="act_approve" class="normal-btn">审批通过</button>
					<button id="act_unapprove" class="normal-btn">审批不通过</button>
				</center>
			</div>
		</div>
